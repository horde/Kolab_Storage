...
use Horde\Kolab\Storage\Test\Stub\DataQuery;
use Horde_Cache;
...
class BaseTest extends TestCase
{
    ...
    public function testStamp()
    {
        ...
        $this->assertEquals(
            unserialize('C:37:"Horde_Kolab_Storage_Folder_Stamp_Uids":86:{a:2:{i:0;a:2:{s:11:"uidvalidity";s:8:"12346789";s:7:"uidnext";i:5;}i:1;a:1:{i:0;i:4;}}}'),
            $this->getMessageStorage()
                ->getData('INBOX/WithDeleted')
                ->getStamp()
    ...
    public function testGetQuery()
    {
        ...
        $data->registerQuery(DataQuery::class, $query);
        $this->assertInstanceOf(
            DataQuery::class,
            $data->getQuery(DataQuery::class)
        );
    }
