...
extends TestCase
{
    ...
    {
        parent::setUp();
        $this->_storage = $this->getMockBuilder(Horde_Kolab_Storage::class)->disableOriginalConstructor()->getMock();
        $this->_connection = $this->createMock(Horde_Kolab_Storage_Driver::class);
    }
