...
use Horde_Kolab_Storage_Synchronization_OncePerSession;
...
extends TestCase
{
    ...
    public function testDataSynchronization()
    {
        $synchronization = new Horde_Kolab_Storage_Synchronization_OncePerSession();
        $data = $this->getMockBuilder(
            Horde_Kolab_Storage_Data_Base::class
    ...
    {
        $synchronization = new Horde_Kolab_Storage_Synchronization_OncePerSession();
        $data = $this->getMockBuilder(Horde_Kolab_Storage_Data_Base::class)->disableOriginalConstructor()->getMock();
        $data->expects($this->once())
            ->method('getId')
            ->will($this->returnValue('test'));
        $synchronization->synchronizeData($data);
