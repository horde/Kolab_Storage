...
use Horde_Kolab_Storage_List_Query_Share;
use Horde_Kolab_Storage_List_Query_Share_Cache;
...
extends TestCase
{
    ...
    {
        $this->query = $this->createMock(Horde_Kolab_Storage_List_Query_Share::class);
