...
extends TestCase
{
    ...
    public function testDataByType()
    {
        ...
        $ns = $this->getMockBuilder(Horde_Kolab_Storage_Folder_Namespace_Element::class)->setConstructorArgs( array('A', 'B', 'C'))->getMock();
        $namespace = $this->getMockBuilder(Horde_Kolab_Storage_Folder_Namespace::class)->setConstructorArgs( array(array()))->getMock();
    ...
    {
        $this->driver = $this->createMock(Horde_Kolab_Storage_Driver::class);
        $this->types = $this->createMock(Horde_Kolab_Storage_Folder_Types::class);
        $this->mock_type = $this->getMockBuilder('Horde_Kolab_Storage_Folder_Type')->setConstructorArgs(['event.default'])->getMock();
