...
use Horde_Kolab_Storage_List_Query_Acl_Cache;
use Horde_Kolab_Storage_List_Query_Acl;
/**
 * Test the cached handling of ACL.
 *
 * Copyright 2011-2017 Horde LLC (http://www.horde.org/)
 *
 * See the enclosed file LICENSE for license information (LGPvL). If you
...
extends TestCase
{
    ...
    {
        $this->query = $this->createMock(Horde_Kolab_Storage_List_Query_Acl::class);
...
;
    ...
    {
        $this->query = $this->createMock(Horde_Kolab_Storage_List_Query_Acl::class);
        $this->cache = $this->createStub(Horde_Kolab_Storage_List_Cache::class);
