 ...
 *
 * As the underlying framework PHPUnit_Story is no longer available
 * this code cannot be upgraded. PHPUnit authors suggest using behat instead.
 * This is currently out of scope for the kolab* components.
 * 
 * PHP version 5
 *
 * @category Kolab
 ...
 * @license  http://www.horde.org/licenses/lgpl21 LGPL 2.1
 */
class Scenario extends Horde_Kolab_Server_Integration_Scenario
{
    /**
     * Handle a "given" step.
     *
